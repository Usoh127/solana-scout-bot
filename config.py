...
class Config:
    ...
    SLIPPAGE_BPS: int = _int("SLIPPAGE_BPS", 300)
    ...
    # ── RugCheck API ──────────────────────────────────────────────────────────
    # Free account at rugcheck.xyz — API works without a key but your account
    # raises rate limits. Leave blank for anonymous access.
    ...
    @property
    def has_rugcheck(self) -> bool:
        return True  # works without a key; account just raises rate limits
